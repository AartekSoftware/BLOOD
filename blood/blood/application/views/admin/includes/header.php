        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#user"><i class="fa fa-user"></i> User Management <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="user" class="collapse">
                            <li>
                                <a href="<?php echo site_url('admin/user/view'); ?>"><i class="fa fa-sign-in"></i> View All User</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-sign-in"></i> Change Password</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="charts.html"><i class="fa fa-file-text"></i> Blood Bank</a>
                    </li>
                    <li>
                        <a href="tables.html"><i class="fa fa-file-text"></i> Request</a>
                    </li>                                        
                    <li>                        
                        <a href="javascript:;" data-toggle="collapse" data-target="#setting"><i class="fa fa-fw fa-wrench"></i> Settings <i class="fa fa-fw fa-caret-down"></i></a>
